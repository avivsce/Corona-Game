...
def game():
    ...
    textTime = my_font.render('Time:',True,black)
    Clock = pygame.time.Clock()
    ...
    while True:
        ...
        screen.blit(textTime, (10, 140))
        sec = timer / 60
        if sec > 59:
            min = min+1
            timer = 0
        screen.blit(my_font.render(str(int(sec)), True, black), (80, 140))
        screen.blit(my_font.render(str(":"), True, black), (70, 140))
        screen.blit(my_font.render(str(min), True, black), (60, 140))
